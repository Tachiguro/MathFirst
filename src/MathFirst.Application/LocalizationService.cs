...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> EnglishStrings = new(StringComparer.Ordinal)
    {
        ...
        ["Onboarding_TutorialStep3Text"] = "MathFirst brings back new, incorrect, weak, or slow facts so each operation can keep improving independently.",
    ...
    private static readonly Dictionary<string, string> GermanStrings = new(StringComparer.Ordinal)
    {
        ...
        ["Onboarding_TutorialStep3Text"] = "MathFirst wiederholt neue, falsche, unsichere oder langsame Aufgaben gezielt, damit sich jede Rechenart unabhängig weiterentwickeln kann.",
    ...
    private static readonly Dictionary<string, string> RussianStrings = new(StringComparer.Ordinal)
    {
        ...
        ["Onboarding_TutorialStep3Text"] = "MathFirst целенаправленно возвращает новые, неверно решённые, неуверенные или медленные задачи, чтобы каждая операция могла развиваться независимо.",
