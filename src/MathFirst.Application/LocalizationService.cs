...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> EnglishStrings = new(StringComparer.Ordinal)
    {
        ...
        ["Onboarding_TutorialStep1Title"] = "Solve the problem",
        ["Onboarding_TutorialStep1Text"] = "Enter the result of the displayed arithmetic fact. Complete answers are submitted automatically.",
        ["Onboarding_TutorialStep2Title"] = "Correct and fast",
        ["Onboarding_TutorialStep2Text"] = "MathFirst evaluates correctness and active response time to adapt your practice.",
        ["Onboarding_TutorialStep3Title"] = "Practice what needs work",
        ["Onboarding_TutorialStep3Text"] = "MathFirst brings back new, incorrect, weak, or slow facts. After each completed number level, a short 12-question mixed round combines the unlocked operations. It is not a pass/fail test.",
        ...
        ["Onboarding_StepReady_Desc"] = "Your first arithmetic fact is ready. The answer timer starts only when you select Get Started.",
        ...
        ["Phase_Checkpoint"] = "Mixed round (0..{0})",
        ["Phase_MixedPractice"] = "Adaptive Mixed Practice",
        ["Training_MixedRoundLabel"] = "Mixed round",
        ["Training_CheckpointBadge"] = "Mixed round · {0}/{1}",
        ["Diagnostics_CheckpointStatus"] = "Mixed round phase",
        ["Diagnostics_CheckpointLevel"] = "Mixed round level",
        ["Diagnostics_CheckpointProgress"] = "Mixed round progress",
        ["Diagnostics_CheckpointScore"] = "Mixed round accuracy",
        ["Diagnostics_CheckpointInactive"] = "None (Standard Practice)",
        ["Diagnostics_MixedRoundProgressValue"] = "{0} / {1} ({2} correct)",
        ...
        ["Diagnostics_Group_Checkpoint"] = "Mixed round status",
        ...
        ["Reset_LearningProgress_Desc"] = "Resets arithmetic learning state, attempt history, mastery, and range progress. Language, appearance, and onboarding remain unchanged.",
    ...
    private static readonly Dictionary<string, string> GermanStrings = new(StringComparer.Ordinal)
    {
        ...
        ["Onboarding_TutorialStep1Title"] = "Aufgabe lösen",
        ["Onboarding_TutorialStep1Text"] = "Gib das Ergebnis der angezeigten Rechenaufgabe ein. Vollständige Antworten werden automatisch übermittelt.",
        ["Onboarding_TutorialStep2Title"] = "Richtig und schnell",
        ["Onboarding_TutorialStep2Text"] = "MathFirst bewertet Richtigkeit und aktive Antwortzeit, um dein Training anzupassen.",
        ["Onboarding_TutorialStep3Title"] = "Üben, was noch schwerfällt",
        ["Onboarding_TutorialStep3Text"] = "MathFirst wiederholt neue, falsche, unsichere oder langsame Aufgaben gezielt. Nach jedem abgeschlossenen Zahlenbereich folgt eine kurze Mischrunde mit 12 Aufgaben aus den freigeschalteten Rechenarten. Sie ist keine Prüfung, die du bestehen musst.",
        ...
        ["Onboarding_StepReady_Desc"] = "Deine erste Rechenaufgabe ist bereit. Der Antworttimer startet erst mit „Los geht's“.",
        ...
        ["Phase_Checkpoint"] = "Mischrunde (0..{0})",
        ["Phase_MixedPractice"] = "Adaptive gemischte Übung",
        ["Training_MixedRoundLabel"] = "Mischrunde",
        ["Training_CheckpointBadge"] = "Mischrunde · {0}/{1}",
        ["Diagnostics_CheckpointStatus"] = "Mischrunden-Phase",
        ["Diagnostics_CheckpointLevel"] = "Mischrunden-Stufe",
        ["Diagnostics_CheckpointProgress"] = "Mischrunden-Fortschritt",
        ["Diagnostics_CheckpointScore"] = "Mischrunden-Trefferquote",
        ["Diagnostics_CheckpointInactive"] = "Keine (Standardübung)",
        ["Diagnostics_MixedRoundProgressValue"] = "{0} / {1} ({2} richtig)",
        ...
        ["Diagnostics_Group_Checkpoint"] = "Mischrunden-Status",
        ...
        ["Reset_LearningProgress_Desc"] = "Setzt Rechenlernstand, Versuchshistorie, Beherrschung und Zahlenbereichsfortschritt zurück. Sprache, Erscheinungsbild und Onboarding bleiben erhalten.",
    ...
    private static readonly Dictionary<string, string> RussianStrings = new(StringComparer.Ordinal)
    {
        ...
        ["Onboarding_TutorialStep1Title"] = "Решите пример",
        ["Onboarding_TutorialStep1Text"] = "Введите результат показанного арифметического примера. Полные ответы отправляются автоматически.",
        ["Onboarding_TutorialStep2Title"] = "Правильно и быстро",
        ["Onboarding_TutorialStep2Text"] = "MathFirst оценивает правильность и активное время ответа, чтобы адаптировать тренировку.",
        ["Onboarding_TutorialStep3Title"] = "Тренируйте то, что требует внимания",
        ["Onboarding_TutorialStep3Text"] = "MathFirst целенаправленно возвращает новые, неверно решённые, неуверенные или медленные задачи. После каждого завершённого числового уровня следует короткий смешанный раунд из 12 задач по открытым операциям. Это не экзамен, который нужно сдать.",
        ...
        ["Onboarding_StepReady_Desc"] = "Первый пример готов. Таймер ответа запустится только после нажатия «Начать».",
        ...
        ["Phase_Checkpoint"] = "Смешанный раунд (0..{0})",
        ["Phase_MixedPractice"] = "Адаптивная смешанная практика",
        ["Training_MixedRoundLabel"] = "Смешанный раунд",
        ["Training_CheckpointBadge"] = "Смешанный раунд · {0}/{1}",
        ["Diagnostics_CheckpointStatus"] = "Фаза смешанного раунда",
        ["Diagnostics_CheckpointLevel"] = "Уровень смешанного раунда",
        ["Diagnostics_CheckpointProgress"] = "Прогресс смешанного раунда",
        ["Diagnostics_CheckpointScore"] = "Точность смешанного раунда",
        ["Diagnostics_CheckpointInactive"] = "Нет (обычная практика)",
        ["Diagnostics_MixedRoundProgressValue"] = "{0} / {1} ({2} верно)",
        ...
        ["Diagnostics_Group_Checkpoint"] = "Статус смешанного раунда",
        ...
        ["Reset_LearningProgress_Desc"] = "Сбрасывает состояние обучения арифметике, историю попыток, освоение и прогресс диапазонов. Язык, оформление и онбординг сохраняются.",
