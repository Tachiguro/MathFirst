...
public sealed class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> EnglishStrings = new(StringComparer.Ordinal)
    {
        ...
        ["Onboarding_TutorialStep1Text"] = "Enter the result of the displayed arithmetic fact and confirm it with Enter.",
    ...
    private static readonly Dictionary<string, string> GermanStrings = new(StringComparer.Ordinal)
    {
        ...
        ["Onboarding_TutorialStep1Text"] = "Gib das Ergebnis der angezeigten Rechenaufgabe ein und bestätige mit der Eingabetaste.",
    ...
    private static readonly Dictionary<string, string> RussianStrings = new(StringComparer.Ordinal)
    {
        ...
        ["Onboarding_TutorialStep1Text"] = "Введите результат показанного арифметического примера и подтвердите клавишей Enter.",
