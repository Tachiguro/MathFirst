...
- **Downstream Release State**:
  ...
  - Active work package `MF-UX-005` is progressing on synchronized `main` (`82c117912f72d6efe16055f8be754c9c577ae15a`).
  - Remaining MF-UX-005 work (Installed Size / App Data investigation, repeatable tester artifact workflow, physical Android verification) is pending dispatch.
