...
- **MF-UX-006 (V1 Privacy, Copy, and Localization Hardening)** was merged to `main` through Pull Request #40 on 2026-09-19 at `ae69f4ae27397fc6edf36a23bb671b0410680be1` (head `606158a233d7cface85fa0ef7bd03c2f9ef4f4cb`):
  ...
  - *Full Exact-Candidate Validation (`FULL_VALIDATION_PASS` on `606158a233d7cface85fa0ef7bd03c2f9ef4f4cb`)*: 1476 passed Core tests, clean Windows/Android Release builds (0 warnings / 0 errors), 0 vulnerable or deprecated NuGet packages, 27/27 valid relative Markdown files, intact ADR registry, and clean `git diff --check`.
